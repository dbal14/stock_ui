        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            {items.map((m, i) => (
                <div key={m.id ?? i} className="card">
                    ...
                    {/* <div className="text-sm text-gray-500 mt-1 margin-top color-up color-down">{m.d_change}</div> */}
                    {/* <div
  className={`text-sm text-gray-500 mt-1 ${ m.d_change.includes('+')? 'color-up' : m.d_change.includes('-')? 'color-down' : '' }`}
>{m.d_change}
</div> */}
<div
